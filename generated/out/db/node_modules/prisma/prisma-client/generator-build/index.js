...
var require_json_parse_even_better_errors = __commonJS({
  "../../node_modules/.pnpm/json-parse-even-better-errors@2.3.1/node_modules/json-parse-even-better-errors/index.js"(exports, module2) {
    ...
    var parseError = /* @__PURE__ */ __name((e2, txt, context) => {
      if (!txt) {
        return {
...
var require_ansi_styles2 = __commonJS({
  "../../node_modules/.pnpm/ansi-styles@3.2.1/node_modules/ansi-styles/index.js"(exports, module2) {
    ...
    function assembleStyles() {
      ...
      const ansi2ansi = /* @__PURE__ */ __name((n2) => n2, "ansi2ansi");
      const rgb2rgb = /* @__PURE__ */ __name((r2, g2, b2) => [r2, g2, b2], "rgb2rgb");
      styles.color.close = "\x1B[39m";
      styles.bgColor.close = "\x1B[49m";
      styles.color.ansi = {
...
var require_semver = __commonJS({
  "../../node_modules/.pnpm/semver@5.7.1/node_modules/semver/semver.js"(exports, module2) {
    ...
    function SemVer(version2, options2) {
      ...
      var m2 = version2.trim().match(options2.loose ? re[LOOSE] : re[FULL]);
      if (!m2) {
        throw new TypeError("Invalid Version: " + version2);
      }
      this.raw = version2;
    ...
    function replaceTilde(comp, options2) {
      ...
      return comp.replace(r2, function(_, M, m2, p2, pr) {
        debug9("tilde", comp, _, M, m2, p2, pr);
        var ret;
        if (isX(M)) {
          ret = "";
        } else if (isX(m2)) {
    ...
    function replaceCaret(comp, options2) {
      ...
      return comp.replace(r2, function(_, M, m2, p2, pr) {
        debug9("caret", comp, _, M, m2, p2, pr);
        var ret;
        if (isX(M)) {
          ret = "";
        } else if (isX(m2)) {
    ...
    function replaceXRange(comp, options2) {
      ...
      return comp.replace(r2, function(ret, gtlt, M, m2, p2, pr) {
        debug9("xRange", comp, ret, gtlt, M, m2, p2, pr);
        var xM = isX(M);
        var xm = xM || isX(m2);
        var xp = xm || isX(p2);
        var anyX = xp;
...
// ../../node_modules/.pnpm/is-core-module@2.10.0/node_modules/is-core-module/core.json
var require_core2 = __commonJS({
  "../../node_modules/.pnpm/is-core-module@2.10.0/node_modules/is-core-module/core.json"(exports, module2) {
    module2.exports = {
      assert: true,
...
// ../../node_modules/.pnpm/is-core-module@2.10.0/node_modules/is-core-module/index.js
var require_is_core_module = __commonJS({
  "../../node_modules/.pnpm/is-core-module@2.10.0/node_modules/is-core-module/index.js"(exports, module2) {
    "use strict";
          ...
          isFile(pkgfile, function(err2, ex) {
            ...
            readPackage(readFile5, pkgfile, function(err3, pkgParam) {
              ...
              if (pkg2 && pkg2.main) {
                ...
                loadAsFile(path9.resolve(x2, pkg2.main), pkg2, function(err4, m2, pkg3) {
                  if (err4)
                    return cb2(err4);
                  if (m2)
      ...
      function loadAsDirectorySync(x2) {
        ...
        if (isFile(pkgfile)) {
          ...
          if (pkg2 && pkg2.main) {
            ...
            try {
              var m3 = loadAsFileSync(path9.resolve(x2, pkg2.main));
              if (m3)
                return m3;
              var n3 = loadAsDirectorySync(path9.resolve(x2, pkg2.main));
              if (n3)
                return n3;
            } catch (e2) {
            }
...
var require_semver2 = __commonJS({
  "../../node_modules/.pnpm/semver@6.3.0/node_modules/semver/semver.js"(exports, module2) {
    ...
    function parse(version2, options2) {
      ...
      var r2 = options2.loose ? re[t2.LOOSE] : re[t2.FULL];
      if (!r2.test(version2)) {
        return null;
      }
      try {
    ...
    function SemVer(version2, options2) {
      ...
      this.options = options2;
      this.loose = !!options2.loose;
      var m2 = version2.trim().match(options2.loose ? re[t2.LOOSE] : re[t2.FULL]);
      if (!m2) {
        throw new TypeError("Invalid Version: " + version2);
      }
      this.raw = version2;
    ...
    Range.prototype.parseRange = function(range) {
      ...
      debug9("comparator trim", range, re[t2.COMPARATORTRIM]);
    ...
    __name(replaceTildes, "replaceTildes");
    function replaceTilde(comp, options2) {
      var r2 = options2.loose ? re[t2.TILDELOOSE] : re[t2.TILDE];
      return comp.replace(r2, function(_, M, m2, p2, pr) {
        debug9("tilde", comp, _, M, m2, p2, pr);
        var ret;
        if (isX(M)) {
    ...
    function replaceCaret(comp, options2) {
      debug9("caret", comp, options2);
      var r2 = options2.loose ? re[t2.CARETLOOSE] : re[t2.CARET];
      return comp.replace(r2, function(_, M, m2, p2, pr) {
        debug9("caret", comp, _, M, m2, p2, pr);
        var ret;
        if (isX(M)) {
    ...
    function replaceXRange(comp, options2) {
      comp = comp.trim();
      var r2 = options2.loose ? re[t2.XRANGELOOSE] : re[t2.XRANGE];
      return comp.replace(r2, function(ret, gtlt, M, m2, p2, pr) {
        debug9("xRange", comp, ret, gtlt, M, m2, p2, pr);
        var xM = isX(M);
        var xm = xM || isX(m2);
    ...
    function coerce(version2, options2) {
      ...
      var match3 = null;
      if (!options2.rtl) {
        match3 = version2.match(re[t2.COERCE]);
      } else {
        var next;
        while ((next = re[t2.COERCERTL].exec(version2)) && (!match3 || match3.index + match3[0].length !== version2.length)) {
    ...
    module2.exports = function(basedir, relfiles) {
      if (relfiles) {
        var files = relfiles.map(function(r2) {
          return path9.resolve(basedir, r2);
        });
      } else {
        var files = basedir;
      }
...
// ../../node_modules/.pnpm/fp-ts@2.12.3/node_modules/fp-ts/lib/function.js
var require_function = __commonJS({
  "../../node_modules/.pnpm/fp-ts@2.12.3/node_modules/fp-ts/lib/function.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_cjs = __commonJS({
  "../../node_modules/.pnpm/@timsuchanek+sleep-promise@8.0.1/node_modules/@timsuchanek/sleep-promise/build/cjs.js"(exports, module2) {
    ...
    function createSleepPromise(a, b2) {
      var c = b2.useCachedSetTimeout, d2 = c ? cachedSetTimeout : setTimeout;
    ...
    function sleep(a) {
      ...
      __name(b2, "b");
      var c = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {}, d2 = c.useCachedSetTimeout, e2 = createSleepPromise(a, { useCachedSetTimeout: d2 });
      return b2.then = function() {
        return e2.then.apply(e2, arguments);
      }, b2.catch = Promise.resolve().catch, b2;
    }
    __name(sleep, "sleep");
  ...
  "../../node_modules/.pnpm/flat-map-polyfill@0.3.8/node_modules/flat-map-polyfill/dist/cjs/flatten.js"() {
    ...
    if (!Object.prototype.hasOwnProperty.call(Array.prototype, "flatten")) {
      Array.prototype.flatten = /* @__PURE__ */ __name(function flatten(depth) {
        var o2 = Object(this);
        var a = (0, _arraySpeciesCreate2.default)(o2, this.length);
        var depthNum = depth !== void 0 ? Number(depth) : Infinity;
        (0, _flattenIntoArray2.default)(a, o2, 0, depthNum);
  ...
  "../../node_modules/.pnpm/flat-map-polyfill@0.3.8/node_modules/flat-map-polyfill/dist/cjs/flat-map.js"() {
    ...
    if (!Object.prototype.hasOwnProperty.call(Array.prototype, "flatMap")) {
      Array.prototype.flatMap = /* @__PURE__ */ __name(function flatMap(callbackFn, thisArg) {
        ...
        var t2 = thisArg !== void 0 ? thisArg : void 0;
        var a = (0, _arraySpeciesCreate2.default)(o2, o2.length);
...
async function getos() {
  ...
  if (platform === "freebsd") {
    const version2 = await gracefulExec(`freebsd-version`);
...
async function getOpenSSLVersion() {
  const [version2, ls] = await Promise.all([
  ...
  if (version2) {
    const v = parseOpenSSLVersion(version2);
    if (v) {
      return v;
    }
  }
  if (ls) {
    const match3 = /libssl\.so\.(\d+\.\d+)\.\d+/.exec(ls);
    if (match3) {
      return match3[1] + ".x";
    }
  }
...
// ../../node_modules/.pnpm/fp-ts@2.12.3/node_modules/fp-ts/es6/function.js
...
// ../../node_modules/.pnpm/fp-ts@2.12.3/node_modules/fp-ts/es6/internal.js
...
var left = /* @__PURE__ */ __name(function(e2) {
...
// ../../node_modules/.pnpm/fp-ts@2.12.3/node_modules/fp-ts/es6/Functor.js
function map(F, G) {
  return function(f2) {
    return function(fa) {
...
// ../../node_modules/.pnpm/fp-ts@2.12.3/node_modules/fp-ts/es6/Either.js
var left2 = left;
var right2 = right;
var _map = /* @__PURE__ */ __name(function(fa, f2) {
  return pipe(fa, map2(f2));
}, "_map");
var URI = "Either";
var map2 = /* @__PURE__ */ __name(function(f2) {
  return function(fa) {
...
var tryCatch = /* @__PURE__ */ __name(function(f2, onThrow) {
  try {
    return right2(f2());
  } catch (e2) {
    return left2(onThrow(e2));
  }
}, "tryCatch");

// ../../node_modules/.pnpm/fp-ts@2.12.3/node_modules/fp-ts/es6/EitherT.js
function right3(F) {
  ...
  return function(f2) {
    return function(ma) {
      return M.chain(ma, function(e2) {
        return isLeft2(e2) ? M.of(e2) : f2(e2.right);
      });
    };
  };
}
...
// ../../node_modules/.pnpm/fp-ts@2.12.3/node_modules/fp-ts/es6/Task.js
var _map2 = /* @__PURE__ */ __name(function(fa, f2) {
  return pipe(fa, map4(f2));
}, "_map");
var _apPar = /* @__PURE__ */ __name(function(fab, fa) {
  return pipe(fab, ap(fa));
}, "_apPar");
var _chain = /* @__PURE__ */ __name(function(ma, f2) {
  return pipe(ma, chain2(f2));
}, "_chain");
var map4 = /* @__PURE__ */ __name(function(f2) {
  return function(fa) {
    return function() {
...
var chain2 = /* @__PURE__ */ __name(function(f2) {
  return function(ma) {
    return function() {
...
// ../../node_modules/.pnpm/fp-ts@2.12.3/node_modules/fp-ts/es6/TaskEither.js
...
var fromEither = of;
var tryCatch2 = /* @__PURE__ */ __name(function(f2, onRejected) {
  return function() {
...
function preliminaryNodeAPIPipeline(options2) {
  return (0, import_function4.pipe)(
    ...
    chainW((queryEnginePath) => {
      return (0, import_function4.pipe)(
        tryCatch2(isNodeAPISupported, (e2) => ({
...
function createSchemaValidationError(reason) {
  return `${import_chalk4.default.redBright.bold("Schema validation error")} - ${reason}`;
}
...
async function getDmmfNodeAPI(options2) {
  ...
  if (isLeft2(preliminaryEither)) {
    const { left: e2 } = preliminaryEither;
    debugErrorType(e2);
    throw new GetDmmfError({ _tag: "unparsed", message: e2.error.message, reason: e2.reason });
  }
  ...
  const error = K(dmmfEither.left).with({ type: "node-api" }, (e2) => {
    debugErrorType(e2);
    const errorOutput = e2.error.message;
    const actualError = (0, import_function5.pipe)(
      tryCatch(
        () => JSON.parse(errorOutput),
        () => {
          debug7(`Couldn't apply JSON.parse to "${errorOutput}"`);
          return new GetDmmfError({ _tag: "unparsed", message: errorOutput, reason: e2.reason });
        }
      ),
      map2((errorOutputAsJSON) => {
        if (errorOutputAsJSON.is_panic) {
          const panic = new RustPanic(
            ...
            errorOutputAsJSON.backtrace || e2.error.stack || "NO_BACKTRACE",
            "query-engine-node-api get-dmmf",
            "QUERY_ENGINE_LIBRARY_CLI" /* QUERY_ENGINE_LIBRARY_CLI */,
            options2.prismaPath,
            e2.datamodel
          );
          debug7(`panic in getDmmfNodeAPI "${e2.type}"`, panic);
          return panic;
        }
        ...
        return new GetDmmfError({
          ...
          reason: createSchemaValidationError(e2.reason),
          errorCode
        });
      }),
    ...
    debugErrorType(e2);
    return new GetDmmfError({ _tag: "unparsed", message: e2.error.message, reason: e2.reason });
  });
  throw error;
}
...
async function getDmmfBinary(options2) {
  ...
  const errorEither = K(dmmfEither.left).with({ type: "execa" }, (e2) => {
    var _a3, _b2;
    debugErrorType(e2);
    if (e2.error.message.includes("Command failed with exit code 26 (ETXTBSY)") && options2.retry && options2.retry > 0) {
      return left2({
        type: "retry",
    ...
    if (isExecaErrorCausedByRustPanic(e2.error)) {
      const panic = new RustPanic(
        e2.error.shortMessage,
        e2.error.stderr,
      ...
      debug7(`panic in getDmmfBinary "${e2.type}"`, panic);
      return right2(panic);
    }
    const errorOutput = (_b2 = e2.error.stderr) != null ? _b2 : e2.error.stdout;
    const actualError = (0, import_function5.pipe)(
      tryCatch(
        () => JSON.parse(errorOutput),
        () => {
  ...
  }).with({ type: "parse-json" }, (e2) => {
    var _a3;
    debugErrorType(e2);
    const message = `Problem while parsing the query engine response at ${queryEnginePath}. ${e2.result.stdout}
${(_a3 = e2.error) == null ? void 0 : _a3.stack}`;
    const error = new GetDmmfError({
      _tag: "unparsed",
      message,
      reason: `${import_chalk5.default.redBright.bold("JSON parsing")} - ${e2.reason}
`
    });
    return right2(error);
  }).with({ type: "retry" }, (e2) => {
...
function warnOnDeprecatedFeatureFlag(previewFeatures) {
  ...
  previewFeatures == null ? void 0 : previewFeatures.forEach((f2) => {
    const removedMessage = removedFeatureFlagMap[f2];
...
function getMappings(mappings, datamodel2) {
  const modelOperations = mappings.modelOperations.filter((mapping) => {
    const model = datamodel2.models.find((m2) => m2.name === mapping.model);
    if (!model) {
...
function getFieldArgName(field, findMany = true) {
  return getArgName(field.outputType.type.name, findMany && field.outputType.isList);
}
__name(getFieldArgName, "getFieldArgName");
function getArgName(name, findMany) {
  if (!findMany) {
    return `${name}Args`;
  }
...
function getReturnType({
  ...
  if (isList || hideCondition) {
    ...
    return `CheckSelect<T, ${promiseOpen}${listOpen}${name}${listClose}${isChaining ? "| Null" : ""}${promiseClose}, ${promiseOpen}${listOpen}${getPayloadName(name)}<T>${listClose}${isChaining ? "| Null" : ""}${promiseClose}>`;
  }
...
const ${lowerCase(ctx.mapping.model)} = await ${ctx.method}({
  ...
  findUniqueOrThrow: {
    body: (ctx) => `Find one ${ctx.singular} that matches the filter or throw
...
function getMethodJSDocBody(action, mapping, model) {
  ...
  const ctx = {
    ...
    firstScalar: model.fields.find((f2) => f2.kind === "scalar"),
...
function getArgs(modelName, actionName) {
  ...
  return `args${actionName === DMMF.ModelAction.findMany || actionName === DMMF.ModelAction.findFirst || actionName === DMMF.ModelAction.deleteMany || actionName === DMMF.ModelAction.createMany || actionName === "findFirstOrThrow" || actionName === "findUniqueOrThrow" ? "?" : ""}: SelectSubset<T, ${getModelArgName(modelName, actionName)}>`;
}
...
function stringifyInputType(t2, prefixFilter, noEnumerable = false, genericsInfo, source) {
  var _a2;
  let type = typeof t2.type === "string" ? GraphQLScalarToJSTypeTable[t2.type] || t2.type : prefixFilter ? `Base${t2.type.name}` : t2.type.name;
  type = (_a2 = JSOutputTypeToInputType[type]) != null ? _a2 : type;
  if (type === "Null") {
    return "null";
  }
  if (genericsInfo.needsGenericModelArg(t2)) {
    if (source) {
      type = `${type}<"${source}">`;
    } else {
  ...
  if (t2.isList) {
    ...
    if (Array.isArray(type)) {
      return type.map((t3) => `${keyword}<${t3}>`).join(" | ");
    } else {
      return `${keyword}<${type}>`;
    }
  }
...
function stringifyInputTypes(inputTypes, prefixFilter, noEnumerable = false, genericsInfo, source) {
  ...
  const filteredInputTypes = inputTypes.filter((t2, i) => !singularPairIndexes.has(i));
  const inputObjectTypes = filteredInputTypes.filter((t2) => t2.location === "inputObjectTypes");
  const nonInputObjectTypes = filteredInputTypes.filter((t2) => t2.location !== "inputObjectTypes");
...
var InputType = class {
  ...
  toTS() {
    ...
    const fields = uniqueBy(type.fields, (f2) => f2.name);
    const body = `{
...
function wrapWithAtLeast(body, input) {
  ...
  if (((_a2 = input.constraints) == null ? void 0 : _a2.fields) && input.constraints.fields.length > 0) {
    const fields = input.constraints.fields.map((f2) => `"${f2}"`).join(" | ");
...
var ArgsType = class {
  ...
  toTS() {
    ...
    const hasRelationField = this.type.fields.some((f2) => f2.outputType.location === "outputObjectTypes");
    if (hasRelationField) {
...
${(0, import_indent_string4.default)(argsToGenerate.map((arg) => new InputField(arg, false, false, this.genericsInfo).toTS()).join("\n"), TAB_SIZE)}
}
`;
  }
...
export interface ${modelArgName} extends ${baseTypeName} {
  ...
  */
  ...
  generateFindOrThrowMethodArgs(action, name, modelArgName) {
    const baseTypeName = getBaseTypeName(name, action);
    return `
/**
 * ${name}: ${action}
...
`;
  ...
  renderRelations(projection) {
    ...
    const relationsProjectionChoice = {
      ["select" /* select */]: () => {
        return type.fields.filter((f2) => {
          return f2.outputType.location === "outputObjectTypes";
        });
      },
      ["include" /* include */]: () => {
        const nonCompositeRelations = type.fields.filter((f2) => {
          return f2.outputType.location === "outputObjectTypes" && typeof f2.outputType.type === "object" && !this.dmmf.typeMap[f2.outputType.type.name];
        });
    ...
    if (projection === "include" /* include */ && relations.length === 0)
      return "";
    const selectPrefix = projection === "select" /* select */ ? ` P extends keyof ${type.name} ? ${type.name}[P] :` : "";
    return `{
  [P in TrueKeys<S['${projection}']>]:
${(0, import_indent_string7.default)(
      relations.map(
        (f2) => `P extends '${f2.name}' ? ${this.wrapType(
          f2,
          `${getPayloadName(
            f2.outputType.type.name
...
var Model = class {
  constructor(model, dmmf2, genericsInfo, generator2) {
    ...
    this.mapping = dmmf2.mappings.modelOperations.find((m2) => m2.model === model.name);
  }
  get argsTypes() {
    const argsTypes = [];
  ...
  rootFieldNameForAction(action) {
    var _a2;
    return (_a2 = this.mapping) == null ? void 0 : _a2[getDmmfActionName(action)];
  }
  getGroupByTypes() {
...
${(0, import_indent_string9.default)(
      groupByRootField.args.map((arg) => {
        ...
        groupByType.fields.filter((f2) => f2.outputType.location === "outputObjectTypes").map((f2) => {
          if (f2.outputType.location === "outputObjectTypes") {
            return `${f2.name}?: ${getAggregateInputType(f2.outputType.type.name)}${f2.name === "_count" ? " | true" : ""}`;
          }
          return "";
        })
      ).join("\n"),
...
${(0, import_indent_string9.default)(
      aggregateRootField.args.map((arg) => {
        ...
        aggregateType.fields.map((f2) => {
          let data = "";
          const comment = getArgFieldJSDoc(this.type, DMMF.ModelAction.aggregate, f2.name);
          data += comment ? wrapComment(comment) + "\n" : "";
          if (f2.name === "_count" || f2.name === "count") {
            data += `${f2.name}?: true | ${getCountAggregateInputName(model.name)}`;
          } else {
            data += `${f2.name}?: ${getAggregateInputType(f2.outputType.type.name)}`;
          }
          return data;
        })
      ).join("\n"),
...
${(0, import_indent_string9.default)(
      model.fields.filter((f2) => f2.kind !== "object" && f2.kind !== "unsupported" || this.dmmf.typeMap[f2.type]).map((field) => new ModelOutputField(this.dmmf, field, !this.dmmf.typeMap[field.type]).toTS()).join("\n"),
      TAB_SIZE
    )}
}
`;
  ...
  toTS() {
    ...
    const hasRelationField = model.fields.some((f2) => f2.kind === "object");
    const includeType = hasRelationField ? `
export type ${getIncludeName(model.name)} = {
${(0, import_indent_string9.default)(
      outputType.fields.filter((f2) => {
        const fieldTypeName = f2.outputType.type.name;
        return f2.outputType.location === "outputObjectTypes" && !this.dmmf.typeMap[fieldTypeName];
      }).map((f2) => {
        const fieldTypeName = f2.outputType.type.name;
        return `${f2.name}?: boolean` + (f2.outputType.location === "outputObjectTypes" ? ` | ${getFieldArgName(f2, !this.dmmf.typeMap[fieldTypeName])}` : "");
      }).join("\n"),
      TAB_SIZE
    )}
}
...
var ModelDelegate = class {
  ...
  getNonAggregateActions(availableActions) {
    const actions = availableActions.filter((key) => key !== "aggregate" && key !== "groupBy");
    for (const [clientOnlyAction, { wrappedAction }] of Object.entries(clientOnlyActions)) {
      if (actions.includes(wrappedAction)) {
        actions.push(clientOnlyAction);
      }
    }
    return actions;
  }
...
`;
    ...
    return `${availableActions.includes(DMMF.ModelAction.aggregate) ? `type ${countArgsName} = Merge<
...
${(0, import_indent_string9.default)(
      fields.filter((f2) => f2.outputType.location === "outputObjectTypes" && f2.name !== "_count").map((f2) => {
        const fieldTypeName = f2.outputType.type.name;
        return `
${f2.name}<T extends ${getFieldArgName(f2, !this.dmmf.typeMap[fieldTypeName])} = {}>(args?: Subset<T, ${getFieldArgName(
          f2,
          !this.dmmf.typeMap[fieldTypeName]
        )}>): ${getReturnType({
          name: fieldTypeName,
          actionName: f2.outputType.isList ? DMMF.ModelAction.findMany : DMMF.ModelAction.findUnique,
          hideCondition: false,
          isField: true,
          renderPromise: true,
          fieldName: f2.name,
...
class ${name} {
  ...
  return (0, import_indent_string10.default)(source, TAB_SIZE);
}
...
${(0, import_indent_string12.default)(sources.map((s) => `${s.name}?: Datasource`).join("\n"), 2)}
}`;
  }
};
...
function interactiveTransactionDefinition() {
  var _a2;
  if (!((_a2 = this.generator) == null ? void 0 : _a2.previewFeatures.includes("interactiveTransactions"))) {
    return "";
  }
...
function extendsDefinition() {
  var _a2;
  if (!((_a2 = this.generator) == null ? void 0 : _a2.previewFeatures.includes("clientExtensions"))) {
    return "";
  }
  return `
  /**
...
__name(extendsDefinition, "extendsDefinition");
...
export class PrismaClient<
  ...
  ${(0, import_indent_string13.default)(this.jsDoc, TAB_SIZE)}
...
${[
    ...
    ${(0, import_indent_string13.default)(
      dmmf2.mappings.modelOperations.filter((m2) => m2.findMany).map((m2) => {
...
${((_a2 = this.generator) == null ? void 0 : _a2.previewFeatures.includes("interactiveTransactions")) ? `
...
`;
  ...
  toTS(edge = false) {
    ...
    const countTypes = this.dmmf.schema.outputObjectTypes.prisma.filter((t2) => t2.name.endsWith("CountOutputType")).map((t2) => new Count(t2, this.dmmf, this.genericsInfo, this.options.generator));
    const code = `
/**
 * Client
**/
